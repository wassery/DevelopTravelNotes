...
（1-4）渐变图，使用Photoshop制作，注意左侧边缘处加入1fx的透明。
 ![pic](.\pic\1-4.png)

（2）场景布局如下。
 ![pic](.\pic\2.png)

（3）Shader Forge编辑如下。（编辑方式看《[Unity插件应用之ShaderForge制作颜色渐变效果](https://blog.csdn.net/minami_takumi/article/details/85054896)》）
 ![pic](.\pic\3.png)
